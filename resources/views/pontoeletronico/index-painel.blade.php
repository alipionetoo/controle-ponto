...
<head>
  ...
  <title>{{ getenv('APP_NAME') }} | Ponto Eletrônico | Painel Administrativo</title>
...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <p class="login-box-msg"><b>Ponto Eletrônico | Painel Administrativo</b></p>
      ...
      <form action="{{ $url_base }}/painel/login" method="post">
        ...
        <div class="row">
          ...
          <hr style="border-top: 1px solid #f2efef;">
          <div class="row">
          </div>
          <div class="row text-center">
            ...
            <div class="col-md-6">
              <a href="/" class="btn btn-md btn-github btn-responsive">Voltar</a>
            </div>
          </div>
      </form>
